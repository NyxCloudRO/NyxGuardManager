...
`docker-compose.yml` is pinned to `nyxmael/nyxguardmanager:3.0.4` for production installs. To use a different version, edit the `image:` tag in `docker-compose.yml`.
