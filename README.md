...
- Install a specific version: `APP_TAG=4.0.9`
...
services:
  nyxguard-manager:
    ...
    image: nyxmael/nyxguardmanager:4.0.9
...
- Force a specific version: `FORCE_TAG=4.0.9`
...
```bash
cd /opt/nyxguardmanager
docker pull nyxmael/nyxguardmanager:4.0.9
