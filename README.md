...
- Install a specific version: `APP_TAG=4.0.5`
...
services:
  nyxguard-manager:
    ...
    image: nyxmael/nyxguardmanager:4.0.5
...
- Force a specific version: `FORCE_TAG=4.0.5`
...
```bash
cd /opt/nyxguardmanager
docker pull nyxmael/nyxguardmanager:4.0.5
