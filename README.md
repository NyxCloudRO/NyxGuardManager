...
- Install a specific version: `APP_TAG=4.0.1`
...
services:
  nyxguard-manager:
    ...
    image: nyxmael/nyxguardmanager:4.0.1
...
- Force a specific version: `FORCE_TAG=4.0.1`
...
```bash
cd /opt/nyxguardmanager
docker pull nyxmael/nyxguardmanager:4.0.1
